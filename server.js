...
const { mountNotificationRoutes } = require('./server/modules/notifications/routes');
...
// 图片上传（货物图 / 取件图）：落盘到 data/uploads，文件名用随机 UUID 防猜测
...
// API 未知路径统一返回 JSON（避免前端 res.json() 解析到 HTML 404 页面）
